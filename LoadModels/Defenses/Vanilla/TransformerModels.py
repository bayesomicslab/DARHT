...
from Defenses.Vanilla import TransformerConfigs as configs
from Defenses.Vanilla import TransformerResNet
ResNetV2 = TransformerResNet.ResNetV2
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False, mean = .5, std = .5):
        ...
        self.matrixMean = torch.ones(3, img_size, img_size)
        self.matrixMean[0] = self.matrixMean[0]*mean
        self.matrixMean[1] = self.matrixMean[1]*mean
        self.matrixMean[2] = self.matrixMean[2]*mean

        self.matrixStd = torch.ones(3, img_size, img_size)
        self.matrixStd[0] = self.matrixStd[0]*std
        self.matrixStd[1] = self.matrixStd[1]*std
        self.matrixStd[2] = self.matrixStd[2]*std
