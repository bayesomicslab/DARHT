...
def earlystop(model, data, target, step_size, epsilon, perturb_steps,tau,randominit_type,loss_fn,rand_init=True,omega=0):
    ...
    if len(output_iter_clean_data) == 2:
        output_iter_clean_data = output_iter_clean_data[0]
...
def mtard_inner_loss_ce(model,
    ...
    for _ in range(perturb_steps):
        ...
        with torch.enable_grad():
            ...
            loss_ce = criterion_ce_loss(model_output, y.cuda())
